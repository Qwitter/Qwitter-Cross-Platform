...
class TweetAvatar extends StatelessWidget {
  ...
  TweetAvatar({Key? key, required this.avatar, this.radius = 20, required this.username}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context) => ProfileDetailsScreen(username: username ),));
      },
      child: Container(
