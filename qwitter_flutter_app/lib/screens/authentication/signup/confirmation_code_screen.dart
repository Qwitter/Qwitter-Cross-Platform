...
class _ConfirmationCodeScreenState
  ...
  Future verifyEmail() async {
    final url = Uri.parse(
        'http://qwitter.cloudns.org:3000/api/v1/auth/verify-email/${codeController.text}');
  ...
  Future resetPassword() async {
    final url = Uri.parse(
        'http://qwitter.cloudns.org:3000/api/v1/auth/reset-password/${codeController.text}');
  ...
  Future changeEmail(String token) async {
    final url =
        Uri.parse('http://qwitter.cloudns.org:3000/api/v1/auth/change-email');
